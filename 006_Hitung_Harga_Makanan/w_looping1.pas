...
repeat
  ...
  writeln('--------------------');
  writeln('Diskon      : Rp. ',besar_diskon:1:2);
  writeln('Total Harga : Rp. ',total_harga:1:2);
  writeln('Pajak       : Rp. ',besar_pajak:1:2);
  writeln('Bayar       : Rp. ',bayar:1:2);

  write('Ulang Pembelian [ya/tidak] : ');readln(ulang);
